<?php
	...
	$pdf->Cell(34,7,iconv("UTF-8", "ISO-8859-1","+ $" . $orden_total['total']),'T',0,'C');//esta es la linea 164
	...
	$pdf->Cell(34,7,iconv("UTF-8", "ISO-8859-1","+ $" . $orden_total['total']),'T',0,'C');//esta es la linea 180
